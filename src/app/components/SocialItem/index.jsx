export default function SocialItem({ name, link }) {
  return (
    <a
      ...
      target="_blank"
      className="group flex items-center justify-between bg-black px-6 py-5 text-2xl transition-colors duration-300 ease-in-out hover:bg-white hover:text-black lg:px-8 lg:py-6 lg:text-4xl"
    >
